...
char pFile[20];
sprintf(pFile,"%s_P.txt",argv[2]);
char bFile[20];
sprintf(bFile,"%s_B.txt",argv[2]);
char rFile[20];
sprintf(rFile,"%s_R.txt",argv[2]);
char qFile[20];
sprintf(qFile,"%s_Q.txt",argv[2]);
char kFile[20];
sprintf(kFile,"%s_K.txt",argv[2]);
char nFile[20];
sprintf(nFile,"%s_N.txt",argv[2]);
